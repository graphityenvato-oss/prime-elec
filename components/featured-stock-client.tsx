              ...
              >
                <Reveal delay={itemIndex * 0.08}>
                  <PrimeCard
                    ...
                    className="flex h-[320px] w-full flex-col bg-muted/20 p-5 shadow-none"
                  >
                    <div className="relative h-36 w-full overflow-hidden rounded-xl border border-border/60 bg-muted/10 p-2">
                      <Image
                        src={category.image}
                        alt={category.title}
                        fill
                    ...
                    <div className="mt-auto pt-4">
                      <Link
                        href={category.href}
                        className="inline-flex rounded-full border border-border/70 px-4 py-2 text-xs font-semibold text-foreground hover:bg-muted/30"
                      >
                        Explore category
                      </Link>
                    </div>
            ...
            >
              {categories.map((category, itemIndex) => (
                <Reveal key={category.title} delay={itemIndex * 0.08}>
                  <PrimeCard
                    data-card
                    className="flex h-[320px] flex-none flex-col bg-muted/20 p-5 shadow-none"
